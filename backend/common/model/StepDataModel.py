...
# !/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :StepDataModel.py
# @Time      :2024/9/23 21:18
# @Author    :XiaoQi
...
from common.model.StepModel import TStep, ValidatorData, TSqlRequest, TRequest, TIFRequest, TWaitRequest, \
...
class ApiBodyFileValueSchema(BaseModel):
    id: str = Field("", description="文件id")
    name: str = Field("", description="文件名称")


class ApiBodyFileDataSchema(BaseModel):
...
class TRequestData(TRequest):
    ...
    data: typing.Union[str, typing.List[typing.Union[ApiBodyFileDataSchema, ApiBaseModel]]] = Field(None,
