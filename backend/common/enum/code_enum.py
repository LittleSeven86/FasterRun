...
# !/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :code_enum.py
# @Time      :2024/9/11 21:33
# @Author    :XiaoQi
...
class CodeEnum(Enum):
    ...
    # http状态码
    SUCCESS_CODE_200 = (200,"200")
    FAILURE_CODE_400 = (400,"请求错误(400)")
    FAILURE_CODE_401 = (401,"未授权，请重新登录(401)")
    FAILURE_CODE_403 = (403,"拒绝访问(403)")
    FAILURE_CODE_404 = (404,"请求出错(404)")
    FAILURE_CODE_422 = (422,"不可处理的实体")
    SERVER_FAILURE_CODE_500 = (500,"不可处理的实体")
    SERVER_FAILURE_CODE_502 = (502,"不可处理的实体")
