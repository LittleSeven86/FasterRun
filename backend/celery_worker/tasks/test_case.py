...
from apps.report.dao.reportDao import ApiTestReport
...
from Runner.models.step_model import TestCase
from Runner.testcase import ZeroRunner
from common.utils.asyc_to_converter import sync_to_async
from db.session import sync_session, SQLAlchemySession
...
async def async_run_testcase(case_id: typing.Union[str, int], report_id: [str, int] = None, **kwargs: typing.Any):
    ...
    case_info = await ApiCaseDao.get(case_id, to_dict=True)
    if not case_id:
