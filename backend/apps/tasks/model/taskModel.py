...
# !/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :taskModel.py
# @Time      :2024/9/23 21:39
# @Author    :XiaoQi
...
class TimedTasksQuerySchema(BaseModel):
    """查询参数序列化"""
...
class TimedTasksListSchema(BaseModel):
    name: str = Field(None, description="")
...
class TimedTasksId(BaseModel):
    """"""
    id: int = Field(..., description="")


class TaskKwargsIn(BaseModel):
    """定时任务执行参数"""
...
class TimedTaskCaseQuery(BaseModel):
