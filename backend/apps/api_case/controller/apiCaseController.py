...
# @Time      :2024/10/3 14:03
# @Author    :XiaoQi

from fastapi import APIRouter

from apps.api_case.model.apiCaseModel import ApiCaseQuery, ApiCaseIn, ApiCaseIdsQuery, ApiTestCaseRun, TestCaseRun, \
    ApiCaseId
from apps.api_case.service.apiService import ApiCaseService
from common.response.http_response import parter_success as partner_success
